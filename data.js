...
const THEMES = {
  ...
  ,"phobies": {
    ...
    tracks: [
      ...
      { answer: "Arachnophobie / Araignée", title: "Black widow", artist: "Iggy Azalea", audio: "widow.mp3", limit: 37, hints: ["Titre", "Une veuve ?"] },
      { answer: "Thalassophobie / Mer / Océan", title: "Face à la mer", artist: "Callogero ft Passi", audio: "mer.mp3", limit: 32, hints: ["Titre", "J'aurai dû grandir"] },
      { answer: "Trypophobie / trous", title: "Le poinçonneur de lilas", artist: "Serge Gainsbourg", audio: "trous.mp3", limit: 30, hints: ["Paroles", "Un bad tryp finalement"] },
      ...
      { answer: "Hippopotomonstrosesquippedaliophobie / Longs mots", title: "Supercalifragilisticexpialidocious", artist: "Frères Sherman", audio: "poppins.mp3", limit: 30, hints: ["Paroles", "Le nom est compliqué"] }
    ]
  }
